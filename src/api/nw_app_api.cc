...
#if defined(OS_WIN)
static bool AddToHKCURegistry(const ScopedVector<RegistryEntry>& registryItems)
{
...
bool NwAppSetDefaultBrowserFunction::SetDefaultBrowserViaRegistry() {
  ...
  registryItems.push_back(new RegistryEntry(L"Software\\Seznam.cz\\WebBrowser\\Capabilities", L"ApplicationDescription", L"Prohlizec Seznam.cz"));
...
bool NwAppRegisterBrowserFunction::SetRegistrationViaRegistry() {
  ...
  registryItems.push_back(new RegistryEntry(L"Software\\Seznam.cz\\WebBrowser\\Capabilities\\FileAssociations", L"html", L"SeznamHTML"));
  registryItems.push_back(new RegistryEntry(L"Software\\Seznam.cz\\WebBrowser\\Capabilities\\FileAssociations", L"htm", L"SeznamHTML"));
  registryItems.push_back(new RegistryEntry(L"Software\\Seznam.cz\\WebBrowser\\Capabilities\\FileAssociations", L"pdf", L"SeznamHTML"));
  registryItems.push_back(new RegistryEntry(L"Software\\Classes\\.htm\\OpenWithProgids", L"SeznamHTML", L""));
  registryItems.push_back(new RegistryEntry(L"Software\\Classes\\.html\\OpenWithProgids", L"SeznamHTML", L""));
  registryItems.push_back(new RegistryEntry(L"Software\\Classes\\.pdf\\OpenWithProgids", L"SeznamHTML", L""));
